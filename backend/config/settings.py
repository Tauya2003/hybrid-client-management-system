...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Hybrid MFI Client Management API',
    'DESCRIPTION': (
        'REST API for the Hybrid Cloud Offline Client Management System '
        'for Microfinance Institutions. Supports offline-first mobile '
        'operations with a custom sync engine.'
    ),
    'VERSION': '1.0.0',
